...
const zend_function_entry iup_functions[] = {
    ...
    PHP_FE(IupGetAllAttributes,  NULL)
    ...
    PHP_FE(IupGetAllNames,  NULL)
    PHP_FE(IupGetAllDialogs,  NULL)
    ...
    PHP_FE(IupGetAllClasses,  NULL)
    PHP_FE(IupGetClassAttributes,  NULL)
    PHP_FE(IupGetClassCallbacks,  NULL)
    ...
    PHP_FE(IupTextConvertLinColToPos,  NULL)
    PHP_FE(IupTextConvertPosToLinCol,  NULL)
